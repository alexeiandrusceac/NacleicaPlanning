...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void updateWorker(Context context,Tasks tasks)
    {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(TASK_WORKER_ID,tasks.idWorker);
        ...
        if (sqLiteDatabase != null) {
            Toast.makeText(context, "Sarcina sa atribuit cu succes", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(context, "Nu sa atribuit sarcina", Toast.LENGTH_SHORT).show();
