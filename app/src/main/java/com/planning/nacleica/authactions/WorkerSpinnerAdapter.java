...
public class WorkerSpinnerAdapter extends ArrayAdapter<Worker> {

    private Context mContext;
    private List<Worker> mValues;

    public WorkerSpinnerAdapter(Context context,
                                 int textViewResourceId, List<Worker> objects) {
